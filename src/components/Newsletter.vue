<template>
      <b-jumbotron bg-variant="primary" text-variant="light" header="START.CODE Newsletter" lead="Erhalte alle News rund ums Programmieren lernen und digitale Weiterbildung direkt in dein Postfach!">
