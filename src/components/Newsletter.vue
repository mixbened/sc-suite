<template>
      <b-jumbotron header="START.CODE Newsletter" lead="News rund ums lernen der Programmierung und digitale Weiterbildung. Von Tutorials bishin zu Kursaktionen. Jetzt nichts mehr verpassen!">
      <form action="https://start-code.us20.list-manage.com/subscribe/post?u=e8429b1b1cc6f7df4af8fbf90&amp;id=2e53d86122" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <b-field style="width: 100%;">
            <b-input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Email Addresse" required></b-input>
        </b-field>
